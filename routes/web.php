...
Route::group(['middleware' => ['auth', 'verified'], 'prefix' => "admin"], function () {
     ...
     * Parking Bay Backend
     */
    Route::resource('parking-bays', 'ParkingBayController')->except('show');
    Route::get('parking-bays/tb-parking-bay', [
        'as' => 'get.data-parking-bay',
        'uses' => 'ParkingBayController@getDataBay'
    ]);
    ...
    Route::get('orders', [
       'as' => 'orders.index',
       'uses'=> 'TransactionsOrdersController@index' 
    ]);
    Route::get('orders/tb-orders', [
        'as' => 'get.data-orders',
        'uses' => 'TransactionsOrdersController@getDataOrders'
    ]);
    Route::get('orders/{id}/show', [
        'as' => 'orders.show',
        'uses' => 'TransactionsOrdersController@show'
    ]);
});

/* For Vue */
// Route::view('/', 'booking.index');
Route::get('/', [
   'as' => 'index.homepage',
...
Route::post('booking', [
    'as' => 'store.booking-payment',
    'uses' => 'BookingController@storePayment'
]);

Route::post('booking-non-payment', [
    'as' => 'store.booking-non-payment',
    'uses' => 'BookingController@storeNonPayment'
]);