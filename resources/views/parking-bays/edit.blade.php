...
{!! Form::open(['route' => ['parking-bays.update', $bays->id], 'method' => 'PUT', 'id' => 'parking-bays-form', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="working_hours_thurs"
                           ...
                           value="{{ $bays->working_hours_thurs }}">
                </div>
            </div>
        </div>
        <div class="row">
