        ...
        <div class="modal fade" id="kt_modal_availability" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="#" id="kt_modal_availability_form">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_availability_header">
                            <!--begin::Modal title-->
                            <h2>Check Availability Bays</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_availability_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                <!--begin::Notice-->
                                <!--begin::Notice-->
                                <div class="notice d-flex bg-light-info rounded border-info border border-dashed mb-9 p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-bold">
                                            ...
                                            <div class="fs-6 text-gray-700">This is the available bays</div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    <!--end::Wrapper-->
